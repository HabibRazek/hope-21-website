  ...
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl">Discutez avec notre équipe amicale </h1>

            <p className="mt-3 text-gray-900 ">Nous aimerions recevoir de vos nouvelles. Veuillez remplir ce formulaire ou envoyez-nous un e-mail.</p>
        </div>

        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    <span className="inline-block p-3 text-orange-500 rounded-full bg-orange-100/80 ">
                    ...
                    <p className="mt-2 text-sm text-gray-500 ">Notre équipe amicale est là pour vous aider</p>
                    <p className="mt-2 text-sm text-orange-500 dark:text-orange-400">atppt21@hotmail.com</p>
                </div>
                ...
                <div>
                    ...
                    <h2 className="mt-4 text-base font-medium text-gray-800">Chat en direct</h2>
                    <p className="mt-2 text-sm text-gray-500 ">Notre équipe amicale est là pour vous aider.</p>
                    <p className="mt-2 text-sm text-orange-500 dark:text-orange-400">Démarrer une nouvelle discussion</p>
                </div>
                ...
                <div>
                    ...
                    <h2 className="mt-4 text-base font-medium text-gray-800">Bureau</h2>
                    <p className="mt-2 text-sm text-gray-500 ">Venez dire bonjour à notre siège social.</p>
                    <p className="mt-2 text-sm text-orange-500 dark:text-orange-400">46 Rue Hsan Abd elwahab Nabeul</p>
                </div>
                ...
                <div>
                    ...
                    <h2 className="mt-4 text-base font-medium text-gray-800">Telephone</h2>
                    <p className="mt-2 text-sm text-orange-500 dark:text-orange-400">72271790</p>
                </div>
            </div>
                ...
                <form>
                    <div className="-mx-2 md:items-center md:flex">
                        ...
                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            <label className="block mb-2 text-sm text-gray-600 ">Prenom</label>
